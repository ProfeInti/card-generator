...
export function buildTechniquesTemplateJson() {
  return {
    ...
    notes: [
      ...
      'Spanish "name" and Spanish "effectDescription" are required. All French fields are optional.',
      ...
      'Fields with equations accept editor HTML or plain text with inline LaTeX between $...$ so mathematical expressions render correctly after import.',
