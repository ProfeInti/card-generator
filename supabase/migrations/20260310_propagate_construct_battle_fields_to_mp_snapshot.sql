-- Propagate construct battle fields into multiplayer match snapshots
-- Date: 2026-03-10
...
alter table public.mp_match_constructs
  drop constraint if exists mp_match_constructs_attack_check;

alter table public.mp_match_constructs
  add constraint mp_match_constructs_attack_check
  check (attack >= 0);

alter table public.mp_match_constructs
  drop constraint if exists mp_match_constructs_armor_check;

alter table public.mp_match_constructs
  add constraint mp_match_constructs_armor_check
  check (armor >= 0);
